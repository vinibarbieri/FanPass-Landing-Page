      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-xl font-bold mb-4 text-gradient-primary">FanPass</h3>
            <p className="text-muted-foreground mb-4 max-w-md">
              Transformando a experiência dos torcedores com tecnologia blockchain. 
              Ingressos NFT oficiais para os maiores clubes do Brasil.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition-colors">Clubes parceiros</a></li>
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">&copy; {currentYear} FanPass. Todos os direitos reservados.</p>
